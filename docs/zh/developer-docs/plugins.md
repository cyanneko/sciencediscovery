...
可从 [Plan 插件入口](../../../packages/plan/src/plugin.ts)、[领域实现](../../../packages/plan/src/index.ts) 与 [manifest](../../../packages/plan/src/manifest.ts) 开始阅读；协议类型见 [SDK](../../../packages/plugin-sdk/src/index.ts)，设置事务见 [SessionStore](../../../services/api/src/store.ts)，完整 HTTP 设置回归旅程见 [plugin-settings-journey](../../../test/st/api/plugin-settings.mjs)。
